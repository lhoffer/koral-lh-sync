  ...
  <div class="minicart">
    <div class="minicart__container">
      ...
      <div class="minicart__form" v-show="cart.item_count > 0">   
        ...
        <div class="minicart__announcements"><slot></slot></div>
        <div class="minicart__summary">
          ...
          <a class="btn btn-primary btn-block" style="background: #FFF; border-color: #FFF;color: #000;" href="/cart">
            <span style="text-decoration: underline;">VIEW MY BAG</span>
          </a>
